...
export const QuantityBadgesGrid = ({ data }: IProductProps) => {
  return (
    <>
      <p className=' left-14 inline-block py-0.5 px-1.5 leading-none whitespace-nowrap font-medium bg-gray-100 text-black text-[14px]  rounded'>
        В наличии
...
export const SalesBadgesGrid = ({ data }: IProductProps) => {
  return (
    <div className=' flex items-center mt-7'>
      <h3 className=' uppercase text-sm font-light'>Купили</h3>
      <div>
        <h3 className=' uppercase text-sm font-medium ml-4'>
          {data.buyAlready} шт.
        </h3>
      </div>
    </div>
